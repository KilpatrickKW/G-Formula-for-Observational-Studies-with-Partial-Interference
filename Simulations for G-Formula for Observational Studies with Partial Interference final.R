...
p_alpha_s_l<-function(L1,L2,N){
  ...
  for (s in 1:(N+1)){ 
    probS_alpha_6[s,]<-dbinom((s-1),N,pi_alpha_6) #oe
    probS_alpha_4[s,]<-dbinom((s-1),N,pi_alpha_4) #oe
    probS_alpha_5[s,]<-dbinom((s-1),N,pi_alpha_5) #oe
  }
  
  return(list(probS_alpha_6=probS_alpha_6,
              probS_alpha_4=probS_alpha_4,
...
#OE values
oe_6_4_truth<-mu_alpha_6_truth-mu_alpha_4_truth
oe_6_5_truth<-mu_alpha_6_truth-mu_alpha_5_truth
oe_5_4_truth<-mu_alpha_5_truth-mu_alpha_4_truth

#compile these together
names_effects<-c("mu_alpha_4_truth","mu_alpha_5_truth","mu_alpha_6_truth","oe_6_4_truth","oe_6_5_truth","oe_5_4_truth")
binom_effect_truth<-data.frame(names_effects)
binom_effect_truth$values<-c(mu_alpha_4_truth,mu_alpha_5_truth,mu_alpha_6_truth,oe_6_4_truth,oe_6_5_truth,oe_5_4_truth)
...
#OEs
oe_6_4<-matrix(NA,nrow=1000,ncol=1)
oe_6_5<-matrix(NA,nrow=1000,ncol=1)
oe_5_4<-matrix(NA,nrow=1000,ncol=1)
...
oe_6_4_se<-matrix(NA,nrow=1000,ncol=1)
oe_6_5_se<-matrix(NA,nrow=1000,ncol=1)
oe_5_4_se<-matrix(NA,nrow=1000,ncol=1)
...
for (kk in 1:1000){
  ...
  #OEs
  oe_6_4[kk,]<-mu_hat_alpha_6[kk,]-mu_hat_alpha_4[kk,]
  oe_6_5[kk,]<-mu_hat_alpha_6[kk,]-mu_hat_alpha_5[kk,]
  oe_5_4[kk,]<-mu_hat_alpha_5[kk,]-mu_hat_alpha_4[kk,]
  
  oe_6_4_est<-mu_hat_alpha_6_est-mu_hat_alpha_4_est
  oe_6_5_est<-mu_hat_alpha_6_est-mu_hat_alpha_5_est
  oe_5_4_est<-mu_hat_alpha_5_est-mu_hat_alpha_4_est
  ...
  estfun_gf <- function(data,models){
    ...
    function(theta){
      ...
      oe_6_4_ee<-(theta[13]-theta[11])-theta[14]
      oe_6_5_ee<-(theta[13]-theta[12])-theta[15]
      oe_5_4_ee<-(theta[12]-theta[11])-theta[16]
  ...
  oe_6_4_se[kk,]<-sqrt(geex_results@vcov[14,14])
  oe_6_5_se[kk,]<-sqrt(geex_results@vcov[15,15])
  oe_5_4_se[kk,]<-sqrt(geex_results@vcov[16,16])
...
#OEs
oe_6_4<-data.frame(oe_6_4)
oe_6_5<-data.frame(oe_6_5)
oe_5_4<-data.frame(oe_5_4)
...
#OEs
oe_6_4$bias<-oe_6_4$oe_6_4-binom_effect_truth$values[binom_effect_truth$names_effects=="oe_6_4_truth"]
oe_6_5$bias<-oe_6_5$oe_6_5-binom_effect_truth$values[binom_effect_truth$names_effects=="oe_6_5_truth"]
oe_5_4$bias<-oe_5_4$oe_5_4-binom_effect_truth$values[binom_effect_truth$names_effects=="oe_5_4_truth"]
...
oe_6_4_avgbias<-mean(oe_6_4$bias)
oe_6_5_avgbias<-mean(oe_6_5$bias)
oe_5_4_avgbias<-mean(oe_5_4$bias)
...
oe_6_4_ase<-mean(oe_6_4$se)
oe_6_5_ase<-mean(oe_6_5$se)
oe_5_4_ase<-mean(oe_5_4$se)
...
oe_6_4_ese<-sd(oe_6_4$oe_6_4)
oe_6_5_ese<-sd(oe_6_5$oe_6_5)
oe_5_4_ese<-sd(oe_5_4$oe_5_4)
...
oe_6_4_ser<-oe_6_4_ase/oe_6_4_ese
oe_6_5_ser<-oe_6_5_ase/oe_6_5_ese
oe_5_4_ser<-oe_5_4_ase/oe_5_4_ese
...
oe_6_4$lowerci<-oe_6_4$oe_6_4-1.96*oe_6_4$se
oe_6_5$lowerci<-oe_6_5$oe_6_5-1.96*oe_6_5$se
oe_5_4$lowerci<-oe_5_4$oe_5_4-1.96*oe_5_4$se

oe_6_4$upperci<-oe_6_4$oe_6_4+1.96*oe_6_4$se
oe_6_5$upperci<-oe_6_5$oe_6_5+1.96*oe_6_5$se
oe_5_4$upperci<-oe_5_4$oe_5_4+1.96*oe_5_4$se
...
oe_6_4$cicov<-ifelse(binom_effect_truth$values[binom_effect_truth$names_effects=="oe_6_4_truth"]>oe_6_4$lowerci & binom_effect_truth$values[binom_effect_truth$names_effects=="oe_6_4_truth"]<oe_6_4$upperci,1,0)
oe_6_5$cicov<-ifelse(binom_effect_truth$values[binom_effect_truth$names_effects=="oe_6_5_truth"]>oe_6_5$lowerci & binom_effect_truth$values[binom_effect_truth$names_effects=="oe_6_5_truth"]<oe_6_5$upperci,1,0)
oe_5_4$cicov<-ifelse(binom_effect_truth$values[binom_effect_truth$names_effects=="oe_5_4_truth"]>oe_5_4$lowerci & binom_effect_truth$values[binom_effect_truth$names_effects=="oe_5_4_truth"]<oe_5_4$upperci,1,0)
